...
public class AppRefreshHead extends BaseHeader {
    ...
    public AppRefreshHead(Context context){
        this(context, R.drawable.shuaxin, R.drawable.arrow);
    }

    public AppRefreshHead(Context context, int rotationSrc, int arrowSrc){
